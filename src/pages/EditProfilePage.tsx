    ...
    if (!session) {
        return createElement(
            ...
            createElement("div", { "className": "page-root" },
                createElement("main", { "className": "min-h-screen px-4 py-6 md:px-6 md:py-10 flex items-center justify-center" },
                    createElement("section", { "className": "glass-panel feed-transition feed-ready w-full max-w-xl rounded-3xl p-6 md:p-8" },
                        createElement("a", { "className": "text-label-sm text-primary", "href": "/home" }, "返回首页"),
                        createElement("h1", { "className": "mt-5 font-display text-[34px] leading-tight text-on-surface" }, "编辑资料"),
                        createElement("div", { "className": "mt-6 rounded-2xl border border-white/40 bg-white/35 px-4 py-4 text-[14px] leading-7 text-on-surface-variant" },
                            "登录后才能编辑资料。",
                            createElement("a", { "className": "ml-2 text-primary font-label-sm", "href": `/login?next=${encodeURIComponent("/me/edit")}` }, "去登录")
                        )
                    )
                )
            )
