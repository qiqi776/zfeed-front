                    ...
                    createElement("aside", { "className": "hidden lg:block lg:col-span-2 relative" },
                        createElement("div", { "className": "sticky top-24 w-full flex flex-col gap-8" },
                            createElement("nav", { "className": "flex flex-col gap-1" },
                                createElement("a", { "className": "flex items-center gap-3 bg-white/60 dark:bg-black/60 text-primary font-bold rounded-lg p-2 shadow-sm ring-1 ring-inset ring-white/40 hover:scale-[1.02] active:scale-95 transition-all duration-300 ease-out", "href": "/home" },
                    ...
                    createElement("main", { "className": "feed-transition col-span-4 md:col-span-8 lg:col-span-7 flex flex-col gap-6 pb-24 feed-ready" },
                        ...
                        createElement("div", { "className": "flex flex-col gap-6" },
                            createElement("article", { "className": "glass-panel rounded-3xl p-6 hover:bg-white/50 hover-lift shine-effect" },
                                createElement("div", { "className": "flex items-center justify-between mb-4 relative z-20" },
                                    createElement("div", { "className": "flex items-center gap-3" },
                                        createElement("a", { "aria-label": "进入 Jax Lee 的主页", "href": "/user/jax" },
                                        ...
                                        createElement("div", null,
                                            createElement("a", { "className": "flex items-center gap-1 cursor-pointer hover:text-primary transition-colors", "href": "/user/jax" },
                                ...
                                createElement("a", { "className": "article-anchor", "href": "/content/article-1" },
                                ...
                                createElement("a", { "className": "glass-panel rounded-2xl overflow-hidden mb-4 border border-white/50 flex flex-col md:flex-row group cursor-pointer relative z-20 hover:shadow-md transition-all duration-300 article-anchor", "href": "/content/article-1" },
                            ...
                            createElement("article", { "className": "glass-panel rounded-3xl p-6 hover:bg-white/50 hover-lift shine-effect" },
                                createElement("div", { "className": "flex items-center justify-between mb-4 relative z-20" },
                                    createElement("div", { "className": "flex items-center gap-3" },
                                        createElement("a", { "aria-label": "进入 Lin Xia 的主页", "href": "/user/lin" },
                                        ...
                                        createElement("div", null,
                                            createElement("a", { "className": "flex items-center gap-1 cursor-pointer hover:text-primary transition-colors", "href": "/user/lin" },
                                                createElement("span", { "className": "font-headline-md text-[16px]" },
                                                    "Lin Xia"
                                                ),
                                ...
                                createElement("a", { "className": "article-anchor", "href": "/content/video-1" },
                                    createElement("h2", { "className": "font-headline-md text-on-surface mb-2 relative z-20 hover:text-primary transition-colors cursor-pointer" },
                                        "创作工具的未来：AI 成为协作副驾"
                                    )
                                ),
                                ...
                                createElement("a", { "className": "relative rounded-2xl overflow-hidden mb-4 group cursor-pointer shadow-sm border border-white/40 hover:shadow-md transition-shadow duration-300 z-20 block article-anchor", "href": "/content/video-1" },
